...
const Card = (props) => {
  ...
  return (
    <div ref={card} className={`${isVisible && `animate-elementIn`} opacity-0 shadow-xl flex flex-col w-[290px] h-[70vh] border-2 ${isMobile ? "mx-[20px] my-[50px]" : "m-[20px]"} py-[30px] px-[30px]`}>
