...
const Landing = () => {
    return (
        <div className="bg-landing bg-cover flex flex-col w-[100vw] h-[100vh] py-[100px] px-[50px] justify-center items-center">
            ...
            <TypeTextAnimation />
            <div className="absolute bottom-[10vh] flex flex-row justify-center w-[100vw]">
