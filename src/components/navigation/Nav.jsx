...
export default function Nav() {
  ...
  return (
    <nav className={`fixed flex flex-row align-center w-screen h-[60px] bg-white/[0] pt-[20px] pb-[20px] select-none duration-100 top-0 right-0 overflow-hidden z-50 ${show ? "opacity-100" : "opacity-0"}`}>
