...
export default function Nav() {
  ...
  return (
    <nav className={`fixed flex flex-row align-center items-center w-screen h-[100px] bg-white pt-[20px] pb-[20px] select-none duration-100 top-0 right-0 overflow-hidden z-50 ${show ? "opacity-100" : "opacity-0"}`}>
